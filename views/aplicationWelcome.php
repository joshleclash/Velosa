            ...
            <div class="menu-left">
				...
				<ul>
					<li>
						<a>Proyectos</a>
						<ul>
							<li><a method="POST" href="#" id="NewProyecto" action="'.PATCH.'/controller/aplicationController.php?option=10" onClick='."submitObjectData('NewProyecto','container-data',{'csc':1})".'>Crear Proyecto</a></li>
							<li><a method="POST" href="#" id="AdminProyecto" action="'.PATCH.'/controller/aplicationController.php?option=11" onClick='."submitObjectData('AdminProyecto','container-data',{'csc':1})".'>Ver Proyecto y Usuarios</a></li>
						</ul>
					</li>
				</ul>
                <ul>
